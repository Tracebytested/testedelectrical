...
- driveImagesInReport: true if Nathan says include/embed/put images IN the report PDF
- driveImagesAttachEmail: true if Nathan says attach images TO the email
- If Nathan says both, set both to true
- If Nathan just says 'attach images' without specifying, default to attaching to email\n- price is ex GST' }]
    })
